...
def filter_top_medications(med_pd: pd.DataFrame, top_n: int = TOP_N_MEDICATIONS) -> pd.DataFrame:
    """
...
def filter_top_diagnoses(diag_pd: pd.DataFrame, top_n: int = TOP_N_DIAGNOSES) -> pd.DataFrame:
    """
